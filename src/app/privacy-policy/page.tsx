          ...
          <div className="bg-black/40 backdrop-blur-sm rounded-2xl p-8 border border-yellow-400/20">
            <div className="prose prose-invert prose-yellow max-w-none">
              <div className="space-y-8 text-yellow-200/90">
                ...
                <section>
                  <h2 className="text-2xl font-bold text-yellow-400 mb-4">5. Cookies and Tracking Technologies</h2>
                  <div className="space-y-3 text-sm leading-relaxed">
                ...
                <section>
                  <h2 className="text-2xl font-bold text-yellow-400 mb-4">8. Changes to This Policy</h2>
                  <div className="space-y-3 text-sm leading-relaxed">
