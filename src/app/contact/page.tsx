      ...
      <div className="container mx-auto max-w-6xl px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-yellow-200/90 text-lg max-w-2xl mx-auto mt-6">
            Have questions about the festival? Want to collaborate? We&apos;d
        ...
        <div className="max-w-4xl mx-auto mb-12 text-center relative z-10">
          <div className="space-y-6 text-yellow-200 bg-black/20 p-6 rounded-lg">
            <p className="text-lg font-medium text-yellow-300">
              If you require any info or want to share what your heart tells
              you, please reach out!
            </p>
            <p className="text-lg text-yellow-200">
              Our team happens thanks to your continuous feedback and support.
              This is a space for open dialogue and exchanging ideas. Let us
              know how we can be of service by filling out the form below or by
              sending us an email.
            </p>
            <div className="space-y-2">
              ...
              <p className="text-lg text-yellow-300">
                Haven Hotel, Ledeta Kefleketema, ADDIS ABABA, ETHIOPIA
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-6">
              ...
              <div className="text-center mb-6">
                <p className="text-yellow-200 text-lg">
                  Fill out the form below, then click &quot;Send Email&quot; to
                  contact our festival team!
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label
                    htmlFor="name"
                    className="block text-lg font-semibold mb-3 text-yellow-400"
                  >
                    Name *
                  </label>
                  <input
              ...
              {resultMessage && (
                <div
                  className={`text-sm text-center mt-4 ${resultType === 'success' ? 'text-green-400' : 'text-red-400'}`}
                >
                  {resultMessage}
                </div>
              )}
