      ...
      <section className="py-20 px-4 relative z-10">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            {/* Text Content */}
            <div className="space-y-6 bg-black/20 backdrop-blur-sm p-6 rounded-xl border border-yellow-400/20">
          ...
          {isExpanded && (
            <div className="mt-16">
              <div className="bg-black/20 backdrop-blur-sm p-8 rounded-xl border border-yellow-400/20 max-w-4xl mx-auto">
      ...
      <section className="py-20 px-4 relative z-10">
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Our Story */}
            <div className="text-center bg-black/20 backdrop-blur-sm p-6 rounded-xl border border-yellow-400/20">
