...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Mobile Menu Overlay */}
      <div className={`fixed inset-0 z-50 md:hidden transition-all duration-300 mobile-menu-overlay ${isMenuOpen ? 'opacity-100 visible' : 'opacity-0 invisible pointer-events-none'}`}>
        <div className="absolute inset-0 bg-black/80 backdrop-blur-sm" onClick={handleMenuToggle}></div>
        <div className={`absolute top-0 right-0 h-full w-64 bg-black/95 backdrop-blur-md border-l border-yellow-400/20 transition-transform duration-300 ${isMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
          <div className="flex flex-col h-full overflow-y-auto">
            ...
            <div className="flex justify-end mb-8 p-8 pb-4">
              <button onClick={handleMenuToggle} className="text-yellow-400 hover:text-yellow-300 transition-colors">
            ...
            <nav className="flex flex-col space-y-6 text-lg font-medium px-8 flex-1">
              <Link href="/" className="text-yellow-200 hover:text-yellow-400 transition-colors hover:scale-105 transform duration-300" onClick={handleMenuToggle}>Home</Link>
              <Link href="/about" className="text-yellow-200 hover:text-yellow-400 transition-colors hover:scale-105 transform duration-300" onClick={handleMenuToggle}>About</Link>
              <Link href="/schedule" className="text-yellow-200 hover:text-yellow-400 transition-colors hover:scale-105 transform duration-300" onClick={handleMenuToggle}>Schedule</Link>
              <Link href="/gallery" className="text-yellow-200 hover:text-yellow-400 transition-colors hover:scale-105 transform duration-300" onClick={handleMenuToggle}>Gallery</Link>
              <Link href="/testimonials" className="text-yellow-200 hover:text-yellow-400 transition-colors hover:scale-105 transform duration-300" onClick={handleMenuToggle}>Testimonials</Link>
              <Link 
            ...
            <div className="mt-auto pt-8 border-t border-yellow-400/20 px-8 pb-8">
                ...
                <div className="flex space-x-4">
                  <a href="https://www.facebook.com/profile.php?id=61564049185674" target="_blank" rel="noopener noreferrer" className="text-yellow-200 hover:text-yellow-400 transition-colors hover:scale-110 transform duration-300">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                    </svg>
                  </a>
                  <a href="https://www.instagram.com/puagmae_fest?igsh=Z2d1NzhyNDduN3hw&utm_source=qr" target="_blank" rel="noopener noreferrer" className="text-yellow-200 hover:text-yellow-400 transition-colors hover:scale-110 transform duration-300">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a href="https://www.tiktok.com/@puagmae.festival?_t=ZM-8yZj67Otrwz&_r=1" target="_blank" rel="noopener noreferrer" className="text-yellow-200 hover:text-yellow-400 transition-colors hover:scale-110 transform duration-300">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
