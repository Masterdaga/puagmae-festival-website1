...
export default function Navbar() {
  ...
  return (
    <>
          ...
          <div className="flex items-center justify-between h-20 py-2">
            ...
            <div className="hidden md:flex items-center gap-6">
              ...
              <Link
                ...
                scroll={true}
                className="bg-gradient-to-r from-yellow-500 to-yellow-600 text-black px-6 py-2 rounded-full font-bold hover:from-yellow-600 hover:to-yellow-700 hover:scale-105 transition-all duration-200 flex items-center shadow-lg"
              >
                Register now
      ...
      {/* Mobile Menu Overlay */}
      <div
        className={`fixed inset-0 z-50 md:hidden transition-all duration-300 mobile-menu-overlay ${isMenuOpen ? 'opacity-100 visible' : 'opacity-0 invisible pointer-events-none'}`}
      >
        <div
        ...
        ></div>
        <div
          className={`absolute top-0 right-0 h-full w-64 bg-black/95 backdrop-blur-md border-l border-yellow-400/20 transition-transform duration-300 ${isMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}
        >
          <div className="flex flex-col h-full overflow-y-auto">
            ...
            <nav className="flex flex-col space-y-6 text-lg font-medium px-8 flex-1">
              <Link
                href="/"
                className="text-yellow-200 hover:text-yellow-400 transition-colors hover:scale-105 transform duration-300"
                onClick={handleMenuToggle}
              >
                Home
              </Link>
            ...
            <div className="mt-auto pt-8 border-t border-yellow-400/20 px-8 pb-8">
              ...
              <div className="flex space-x-4">
                <a
                  ...
                  className="text-yellow-200 hover:text-yellow-400 transition-colors hover:scale-110 transform duration-300"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
