...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-b from-black to-gray-900 w-full overflow-x-hidden">
      ...
      <div className="bg-gradient-to-r from-yellow-600/10 to-yellow-700/10 backdrop-blur-sm py-6 px-4 border-t border-yellow-400/20">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-4">
            ...
            <p className="text-yellow-200/80 max-w-lg mx-auto">
              Be the first to know about updates, exclusive content, and festival announcements.
            </p>
          </div>
          ...
          <div className="max-w-sm mx-auto">
            <div className="flex flex-col gap-3">
              <input
                ...
                className="w-full bg-black/40 backdrop-blur-sm border-2 border-yellow-400/30 text-yellow-200 placeholder-yellow-300/60 px-4 py-3 rounded-full focus:outline-none focus:border-yellow-400 transition-colors text-base"
              />
              <button className="bg-gradient-to-r from-yellow-500 to-yellow-600 text-black px-6 py-3 rounded-full font-semibold hover:from-yellow-600 hover:to-yellow-700 transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2">
                <span>Subscribe</span>
            ...
            <p className="text-xs text-yellow-200/60 text-center mt-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-yellow-200">
              ...
              <div className="space-y-3">
                <a href="#" className="flex items-center space-x-3 hover:text-yellow-300 transition-colors group">
      ...
      {/* Copyright Section */}
      <div className="bg-black/80 backdrop-blur-sm border-t border-yellow-400/20">
