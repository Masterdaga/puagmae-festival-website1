...
export default function Footer() {
  ...
  const handleSubscribe = async () => {
    ...
    try {
      ...
      // Subscription error handled silently with user feedback
          ...
          <div className="max-w-lg mx-auto">
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <button
                ...
                className={`px-6 py-4 rounded-full font-bold text-lg transition-all duration-300 transform flex items-center justify-center gap-2 shadow-lg min-w-fit ${
                  isSubscribing || !email
            ...
            <div className="text-yellow-200">
              ...
              <div className="space-y-3">
                <div className="flex items-center">
                  <a
                    href="https://www.facebook.com/profile.php?id=61564049185674"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center space-x-3 hover:text-yellow-300 transition-colors group"
                  >
                    <div className="w-8 h-8 bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform flex-shrink-0">
                      <svg
                ...
                <div className="flex items-center">
                  <a
                    href="https://www.instagram.com/puagmae_fest?igsh=Z2d1NzhyNDduN3hw&utm_source=qr"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center space-x-3 hover:text-yellow-300 transition-colors group"
                  >
                    <div className="w-8 h-8 bg-gradient-to-br from-yellow-600 to-yellow-700 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform flex-shrink-0">
                      <svg
                ...
                <div className="flex items-center">
                  <a
                    href="https://www.tiktok.com/@puagmae.festival?_t=ZM-8yZj67Otrwz&_r=1"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center space-x-3 hover:text-yellow-300 transition-colors group"
                  >
                    <div className="w-8 h-8 bg-gradient-to-br from-yellow-700 to-yellow-800 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform flex-shrink-0">
                      <svg
                        className="w-4 h-4 text-white"
                        fill="currentColor"
                        viewBox="0 0 24 24"
              ...
              <div className="space-y-3">
                <div className="flex items-start">
                  ...
                  <div className="text-sm">
                    <a
                      href="https://mail.google.com/mail/?view=cm&fs=1&to=puagmaef@gmail.com"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="hover:text-yellow-300 transition-colors"
                    >
                    ...
                    <br />
                    <a
                      href="https://mail.google.com/mail/?view=cm&fs=1&to=pjafrica.2020@gmail.com"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="hover:text-yellow-300 transition-colors"
                    >
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <span className="text-sm">
                      Ledeta Kefleketema, Kebele 49, At last floor of Haven
                      Hotel
                    </span>
                  </div>
                </div>
              ...
              <div className="mt-6">
                ...
                >
                  <div className="text-center">
                    <div className="text-xs font-bold mb-0.5 tracking-wider uppercase">
                      GET IN TOUCH
                    </div>
        ...
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex flex-col md:flex-row items-center justify-between text-yellow-200/80 text-xs">
            ...
            <div className="flex items-center space-x-4">
              <Link
                href="/privacy-policy"
                className="text-yellow-200/60 hover:text-yellow-300 transition-colors"
              >
                Privacy Policy
              </Link>
              <Link
          ...
          <div className="relative bg-black/90 border border-yellow-500 rounded-2xl shadow-2xl w-full max-w-md mx-4 animate-fade-in">
            ...
            <div className="p-6">
              ...
              <div className="mt-4 flex justify-end gap-3">
                <button
                  onClick={() => setShowUnsub(false)}
                  className="px-4 py-2 rounded-full bg-gray-700 text-gray-200 hover:bg-gray-600"
                >
                  Cancel
                </button>
                <button
                  onClick={async () => {
                    ...
                    try {
                      const response = await fetch(
                        `${process.env.NEXT_PUBLIC_API_BASE_URL}/api/newsletter/unsubscribe`,
                        {
                          method: 'POST',
                      ...
                      // Unsubscribe error handled silently with user feedback
                      toast.error(
