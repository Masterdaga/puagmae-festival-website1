            ...
            <div className="text-yellow-200">
              ...
              <div className="space-y-2">
                <ul className="space-y-2">
                  ...
                  <li className="flex items-center">
                    <span className="w-2 h-2 bg-yellow-400 rounded-full mr-3 flex-shrink-0"></span>
                    <a href="/schedule" className="hover:text-yellow-300 transition-colors">Schedule</a>
                  </li>
                  <li className="flex items-center">
                    <span className="w-2 h-2 bg-yellow-400 rounded-full mr-3 flex-shrink-0"></span>
            ...
            <div className="text-yellow-200">
              ...
              <div className="space-y-3">
                <div className="flex items-center">
                  <a href="https://www.facebook.com/profile.php?id=61564049185674" target="_blank" rel="noopener noreferrer" className="inline-flex items-center space-x-3 hover:text-yellow-300 transition-colors group">
                ...
                <div className="flex items-center">
                  <a href="https://www.instagram.com/puagmae_fest?igsh=Z2d1NzhyNDduN3hw&utm_source=qr" target="_blank" rel="noopener noreferrer" className="inline-flex items-center space-x-3 hover:text-yellow-300 transition-colors group">
                ...
                <div className="flex items-center">
                  <a href="https://www.tiktok.com/@puagmae.festival?_t=ZM-8yZj67Otrwz&_r=1" target="_blank" rel="noopener noreferrer" className="inline-flex items-center space-x-3 hover:text-yellow-300 transition-colors group">
