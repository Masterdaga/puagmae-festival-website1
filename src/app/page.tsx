          ...
          <div className="container mx-auto max-w-7xl">
            <div className="text-center mb-20">
              ...
              <p className="text-xl text-yellow-100/70 max-w-3xl mx-auto">
                Experience the ultimate celebration with world-class
                performances, cultural exhibitions, and unforgettable moments
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
              ...
              <div className="group relative bg-gradient-to-br from-[#2d2217] to-black rounded-2xl p-6 border border-yellow-700 hover:border-yellow-400 transition-all duration-500 hover:scale-105 shadow-lg">
                <div className="relative z-10">
                  ...
                  <p className="text-yellow-100/70 text-sm leading-relaxed">
                    Peace talks, cultural exchange, candlelight ceremony,
                    opening parade
                  </p>
                </div>
              </div>
              ...
              <div className="group relative bg-gradient-to-br from-[#2d2217] to-black rounded-2xl p-6 border border-yellow-700 hover:border-yellow-400 transition-all duration-500 hover:scale-105 shadow-lg">
                <div className="relative z-10">
                  ...
                  <p className="text-yellow-100/70 text-sm leading-relaxed">
                    Keynote talks, African unity workshops, traditional music &
                    dance
                  </p>
                </div>
              </div>
              ...
              <div className="group relative bg-gradient-to-br from-[#2d2217] to-black rounded-2xl p-6 border border-yellow-700 hover:border-yellow-400 transition-all duration-500 hover:scale-105 shadow-lg">
                <div className="relative z-10">
                  ...
                  <p className="text-yellow-100/70 text-sm leading-relaxed">
                    Community fun run, outdoor games, rain dance, water
                    activities
                  </p>
                </div>
              </div>
              ...
              <div className="group relative bg-gradient-to-br from-[#2d2217] to-black rounded-2xl p-6 border border-yellow-700 hover:border-yellow-400 transition-all duration-500 hover:scale-105 shadow-lg">
                <div className="relative z-10">
                  ...
                  <p className="text-yellow-100/70 text-sm leading-relaxed">
                    Artisan market, business networking, craft workshops, food
                    stalls
                  </p>
                </div>
              </div>
              ...
              <div className="group relative bg-gradient-to-br from-[#2d2217] to-black rounded-2xl p-6 border border-yellow-700 hover:border-yellow-400 transition-all duration-500 hover:scale-105 shadow-lg">
                <div className="relative z-10">
                  ...
                  <p className="text-yellow-100/70 text-sm leading-relaxed">
                    Fashion show, art exhibition, cultural showcase, grand
                    pageant
                  </p>
                </div>
              </div>
        ...
        <section className="py-24 px-4 relative">
          ...
          <div className="container mx-auto max-w-4xl text-center relative z-10">
            ...
            <p className="text-xl text-yellow-100/80 mb-12 max-w-2xl mx-auto">
              Join thousands of festival-goers for an unforgettable celebration
              of culture, music, and community spirit.
            </p>
