              ...
              <div className="space-y-8 text-yellow-200/90">
                ...
                <section>
                  ...
                  <div className="space-y-3 text-sm leading-relaxed">
                    ...
                    <p>Cookies allow websites to remember your preferences, understand how you use the site, and provide you with a more personalized experience.</p>
                  </div>
                </section>

                <section>
                  <h2 className="text-2xl font-bold text-yellow-400 mb-4">2. How We Use Cookies</h2>
                  <div className="space-y-3 text-sm leading-relaxed">
                    ...
                    <ul className="list-disc list-inside ml-4 space-y-2">
                      ...
                      <li><strong>Functionality Cookies:</strong> These cookies remember your preferences and settings</li>
                ...
                <section>
                  ...
                  <div className="space-y-4 text-sm leading-relaxed">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-yellow-300 mb-2">Essential Cookies</h3>
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-yellow-300 mb-2">Analytics Cookies</h3>
                      <p>These cookies allow us to count visits and traffic sources so we can measure and improve the performance of our site. They help us to know which pages are the most and least popular and see how visitors move around the site.</p>
                    </div>

                    <div>
                      <h3 className="text-lg font-semibold text-yellow-300 mb-2">Functional Cookies</h3>
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-yellow-300 mb-2">Marketing Cookies</h3>
                ...
                <section>
                  <h2 className="text-2xl font-bold text-yellow-400 mb-4">4. Third-Party Cookies</h2>
                  <div className="space-y-3 text-sm leading-relaxed">
                ...
                <section>
                  ...
                  <div className="space-y-3 text-sm leading-relaxed">
                    ...
                    <ul className="list-disc list-inside ml-4 space-y-2">
                      <li><strong>Browser Settings:</strong> Most web browsers allow you to manage cookies through their settings preferences</li>
                      <li><strong>Cookie Consent:</strong> We provide cookie consent options when you first visit our website</li>
                      <li><strong>Third-Party Opt-outs:</strong> Many third-party services provide opt-out mechanisms</li>
                    </ul>
                ...
                <section>
                  <h2 className="text-2xl font-bold text-yellow-400 mb-4">6. Cookie Duration</h2>
                  <div className="space-y-3 text-sm leading-relaxed">
                    ...
                    <p>The specific duration of each cookie varies depending on its purpose and the service provider.</p>
                  </div>
                </section>
                ...
                <section>
                  <h2 className="text-2xl font-bold text-yellow-400 mb-4">8. Updates to This Policy</h2>
                  <div className="space-y-3 text-sm leading-relaxed">
                    <p>We may update this Cookie Policy from time to time to reflect changes in our practices or for other operational, legal, or regulatory reasons. We will notify you of any material changes by posting the new Cookie Policy on this page.</p>
                  </div>
                </section>
