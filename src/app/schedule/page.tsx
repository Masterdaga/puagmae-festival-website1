            ...
            >
              ...
              <AnimatePresence>
                {openIndex === idx && (
                  ...
                  >
                    <div
                      className={`border-t border-amber-200/30 bg-gradient-to-r ${item.color}`}
                    >
                      <div className="p-6">
                        <div
                        ...
                        >
                          {/* Activities List */}
                          <div
                            className={`space-y-4 ${idx % 2 === 1 ? 'md:order-2' : ''}`}
                          >
        ...
        <div className="mt-12 bg-white/90 backdrop-blur-sm rounded-2xl p-6 shadow-lg max-w-md mx-auto border border-amber-200/30">
          ...
          >
            ...
            <p className="text-sm text-slate-600 mt-1">
              Click to {showMap ? 'hide' : 'view'} location details
            </p>
          </div>
