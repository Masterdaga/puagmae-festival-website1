...
export default function AdminDashboard() {
  ...
  const authHeader = useMemo(() => {
    ...
    const token =
      typeof window !== 'undefined' ? btoa(`${username}:${password}`) : '';
  ...
  const fetchData = async () => {
    try {
      ...
      if (regRes.status === 401) {
        ...
        throw new Error(
          remaining !== undefined
            ? `Wrong credentials. You have ${remaining} more ${remaining === 1 ? 'chance' : 'chances'}.`
  ...
  type ColumnDef = {
    ...
    mapper?: (value: unknown, row: Record<string, unknown>) => string;
  };
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-amber-100/80">
            View registrations and newsletter subscribers
          </p>
        </div>
        ...
        <div className="bg-black/70 border border-yellow-500 rounded-2xl p-6 mb-8 max-w-xl mx-auto">
          <div className="grid grid-cols-1 gap-4">
            ...
            <div className="flex gap-3">
              ...
              {isAuthed && (
                <span className="self-center text-green-300 text-sm">
                  Authenticated
                </span>
              )}
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <section className="bg-black/70 border border-yellow-500 rounded-2xl p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <button
                  onClick={() =>
                    exportCsv(registrations, 'registrations.csv', [
                      { key: 'id', title: 'ID' },
                      { key: 'name', title: 'Name' },
                ...
                <table className="min-w-full text-sm text-yellow-100/90">
                  ...
                  <tbody>
                      ...
                      <tr key={r.id} className="odd:bg-white/5">
                        ...
                        <td className="p-2">
                          <button
                            ...
                            className="px-3 py-1 text-xs rounded-full bg-red-600 hover:bg-red-700 text-white"
                          >
                            Cancel Registration
                          </button>
                        </td>
                    ...
                    {!registrations.length && (
                      <tr>
                        <td colSpan={5} className="p-3 text-yellow-200/70">
            ...
            <section className="bg-black/70 border border-yellow-500 rounded-2xl p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <button
                  onClick={() =>
                    exportCsv(subs, 'subscribers.csv', [
                      { key: 'email', title: 'Email' },
              ...
              <div className="overflow-auto max-h-[480px]">
                <table className="min-w-full text-sm text-yellow-100/90">
                  ...
                  <tbody>
                    ...
                    {!subs.length && (
                      <tr>
                        <td colSpan={3} className="p-3 text-yellow-200/70">
            ...
            <section className="bg-black/70 border border-yellow-500 rounded-2xl p-6 lg:col-span-2">
              ...
              {settingsError && (
                <div className="mt-2 text-red-300 text-sm">{settingsError}</div>
              )}
            </section>
          </div>
        )}
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="relative bg-black/90 border border-yellow-500 rounded-2xl shadow-2xl w-full max-w-md mx-4 animate-fade-in">
              ...
              <div className="p-6 text-yellow-100/90">
                <p>
                  Cancel registration for &quot;{confirmTarget.name}&quot; (
                  {confirmTarget.email})?
                </p>
